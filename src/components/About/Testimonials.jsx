  ...
  return (
    <>
      <div className="mt-12 bg-black-100 rounded-2xl ">
        <div className="bg-tertiary rounded-2xl min-h-[300px] px-16  py-16" ref={ref}>
          <animated.div style={styles}>
            <p className="sectionSubText">What Other's say</p>
            <h2 className="sectionHeadText">Testimonials.</h2>
          </animated.div>
          <div className="w-full -mt-20 grid grid-cols-1    sm:grid-cols-2 md:grid-cols-3 gap-7 rounded-3xl px-4 md:px-6">
